...
import static android.app.PendingIntent.FLAG_IMMUTABLE; //CVE-2020-0422
...
public class NotificationImportExportListener implements VCardImportExportListener,
    ...
    /* package */ static Notification constructProgressNotification(
        ...
        builder.setOngoing(true)
                ...
                .setContentIntent(PendingIntent.getActivity(context, 0, intent, FLAG_IMMUTABLE)); //CVE-2020-0422
        if (totalCount > 0) {
            String percentage =
